  ...
  return (
    <footer className='bg-green-900 text-gray-200 py-10'>
      <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
        ...
        <div className='mb-6 md:mb-0'>
            <Link to='/'>
              ...
              <h1 className='text-red-500 text-2xl font-bold'>ThannShop</h1>
            </Link>
            <p className='text-sm'>Email: bunthann855@gmail.com</p>
            <p className='text-sm'>Phone: (855) 967335422</p>
        </div>
        {/* customer service link */}
        <div className='mb-6 md:mb-0'>
            <h3 className='text-xl font-semibold text-red-500'>Customer Service</h3>
      ...
      <div className='mt-8 border-t border-gray-700 pt-6 text-center text-sm'>
        <p>&copy; {new Date().getFullYear()} <span className='text-red-500'>ThannShop</span>. All rights reserved</p>
      </div>
    </footer>
  )
}
